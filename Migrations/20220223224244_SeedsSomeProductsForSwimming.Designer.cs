...
namespace SportyApi.Migrations
{
    ...
    [Migration("20220223224244_SeedsSomeProductsForSwimming")]
    partial class SeedsSomeProductsForSwimming
    {
            ...
            modelBuilder.Entity("SportyApi.Models.Core.Domain.Level", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            LevelId = new Guid("7182f206-ca42-4ce1-a1de-c2eb02fb9c4c"),
                            Description = "Beginner",
                            SportId = new Guid("560408b9-1dea-4fe6-9f68-1cc1d6c703b5")
                        },
                        new
                        {
                            LevelId = new Guid("0160534f-c790-421e-bf95-9e5b3cb987aa"),
                            Description = "Intermediate",
                            SportId = new Guid("560408b9-1dea-4fe6-9f68-1cc1d6c703b5")
                        },
                        new
                        {
                            LevelId = new Guid("25772876-b76f-4460-85a3-107069f740ae"),
                            Description = "Advanced",
                            SportId = new Guid("560408b9-1dea-4fe6-9f68-1cc1d6c703b5")
                        },
                        new
                        {
                            LevelId = new Guid("c22533ff-6aec-4a1a-9827-19c970deb60f"),
                            Description = "Beginner",
                            SportId = new Guid("2eb7d589-7dc9-453f-9a8d-00f53ef9449b")
                        },
                        new
                        {
                            LevelId = new Guid("fbc8a658-f1aa-426c-b9b7-4122eaa3512a"),
                            Description = "Intermediate",
                            SportId = new Guid("2eb7d589-7dc9-453f-9a8d-00f53ef9449b")
                        },
                        new
                        {
                            LevelId = new Guid("1cf99d32-57e5-436a-9bd2-c5248d6ab9ef"),
                            Description = "Advanced",
                            SportId = new Guid("2eb7d589-7dc9-453f-9a8d-00f53ef9449b")
                        });
                });
            ...
            modelBuilder.Entity("SportyApi.Models.Core.Domain.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ProductId = new Guid("4bc6b8b7-2d46-4b16-9845-9169e1cfc143"),
                            Brand = "Arena",
                        ...
                        new
                        {
                            ProductId = new Guid("5bade43f-9b1b-4734-9f98-09d7407a2783"),
                            Brand = "COPOZZ",
                        ...
                        new
                        {
                            ProductId = new Guid("3f52ad2f-8e0a-4c75-b79a-e32dc25749b2"),
                            Brand = "COPOZZ",
                        ...
                        new
                        {
                            ProductId = new Guid("fbdec713-f929-4937-a88e-9cf548bf058f"),
                            Brand = "Queshark",
                        ...
                        new
                        {
                            ProductId = new Guid("5a4ecc08-d24f-47f4-a52b-6b60a10f26ea"),
                            Brand = "Speedo",
            ...
            modelBuilder.Entity("SportyApi.Models.Core.Domain.Sport", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SportId = new Guid("8243cf2c-ca44-4e16-87d3-e8f8c9ae18e2"),
                            Name = "Swimming"
                        },
                        new
                        {
                            SportId = new Guid("28cdec99-04f4-4531-8a53-68cc31c00e59"),
                            Name = "Gym"
                        });
                });
