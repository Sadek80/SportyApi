...
namespace SportyApi.Migrations
{
    ...
    [Migration("20220225131748_AddsCreditCardAndAddressToOrder")]
    partial class AddsCreditCardAndAddressToOrder
    {
            ...
            modelBuilder.Entity("SportyApi.Models.Core.Domain.Order", b =>
                {
                    ...
                    b.OwnsOne("SportyApi.Models.Core.Domain.OrderPaymentData", "OrderPaymentData", b1 =>
                        {
                            ...
                            b1.OwnsOne("SportyApi.Models.Core.Domain.Address", "OrderAddress", b2 =>
                                {
                                    b2.Property<Guid>("OrderPaymentDataOrderId")
                                        .HasColumnType("uniqueidentifier");

                                    b2.Property<int>("BuildingNumber")
                                        .HasColumnType("int");
                                    ...
                                    b2.HasKey("OrderPaymentDataOrderId");

                                    b2.ToTable("Orders");

                                    b2.WithOwner()
                                        .HasForeignKey("OrderPaymentDataOrderId");
                                });

                            b1.Navigation("OrderAddress");
                        });

                    b.Navigation("OrderPaymentData")
                        .IsRequired();
